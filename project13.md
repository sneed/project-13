...
```
![env-vars.yml](images/env-vars-yml.png)
...
![Upload changes to Github git pull](images/git-add-commit-push.png)
...
```
![Site.yml](images/playbook-siteyml.png)
...
![Run Ansible command](images/updateinv-dev.png)
